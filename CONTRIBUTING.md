...
Before submitting a firmware or host-tool change, run `make test`. Changes intended for a release must also satisfy the gates in [`docs/release-checklist.md`](docs/release-checklist.md).
